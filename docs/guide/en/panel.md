...
Click the ☀️ icon to open the panel: four cards that sum everything up at a glance.
...
Unchecking everything shows only the ☀️ icon. The same tab offers the **theme**: Auto (follows macOS), Dark or Light.
